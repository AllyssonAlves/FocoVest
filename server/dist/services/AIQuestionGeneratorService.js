    ...
    generateAlternatives(template, variables) {
        ...
        switch (template.subject) {
            ...
            case 'Biologia':
                ...
                break;
            case 'Português':
                alternatives.push('A tecnologia é prejudicial', 'A comunicação mudou com a tecnologia', 'Os desafios sociais são inevitáveis', 'A tecnologia resolve todos os problemas', 'A comunicação é dispensável');
                break;
            default:
